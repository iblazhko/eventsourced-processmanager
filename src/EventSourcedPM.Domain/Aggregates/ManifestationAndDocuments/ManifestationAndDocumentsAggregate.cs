...
{
    public static IEnumerable<BaseShipmentEvent> Create(ShipmentProcessCategory processCategory, ShipmentId shipmentId, ShipmentLeg[] legs) =>
        [
    ...
    public static IEnumerable<BaseShipmentEvent> GenerateCustomsInvoice(ShipmentProcessCategory processCategory, ShipmentId shipmentId) =>
        [
            new CustomsInvoiceGenerated
            {
                ShipmentId = (string)shipmentId,
                ProcessCategory = (string)processCategory,
                DocumentLocation = new Uri($"https://shipment-documents.net/{shipmentId}/customs-invoice"),
            },
        ];
    ...
    {
        var legsToBeManifested = legs.Where(l => manifestedLegs.All(m => m.CarrierId != l.CarrierId)).ToList();
        return
        [
    ...
    public static IEnumerable<BaseShipmentEvent> GenerateReceipt(ShipmentProcessCategory processCategory, ShipmentId shipmentId) =>
        [
    ...
    public static IEnumerable<BaseShipmentEvent> GenerateCombinedDocument(ShipmentProcessCategory processCategory, ShipmentId shipmentId) =>
        [
            new ShipmentCombinedDocumentGenerated
            {
                ShipmentId = (string)shipmentId,
                ProcessCategory = (string)processCategory,
                DocumentLocation = new Uri($"https://shipment-documents.net/{shipmentId}/combined-document"),
            },
        ];
}
