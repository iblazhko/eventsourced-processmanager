...
{
    public static readonly ShipmentProcessCategory ShipmentProcessCategory = (ShipmentProcessCategory)"domestic-1.0";
        ...
        trigger.Match(
            processEvent =>
                processEvent switch
                {
                    ...
                    ManifestationAndDocumentsStarted x => DecideThat.ShipmentManifestationStarted(x),
